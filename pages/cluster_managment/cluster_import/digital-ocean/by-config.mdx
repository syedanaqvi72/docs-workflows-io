...
* [Choose File ](/cluster_managment/cluster_import/digital-ocean/by-config#choose-file): Upload a Kubeconfig file directly.
* [Manual Kubeconfig](/cluster_managment/cluster_import/digital-ocean/by-config#manual-kubeconfig): Manually enter the Kubeconfig details.
<br />
