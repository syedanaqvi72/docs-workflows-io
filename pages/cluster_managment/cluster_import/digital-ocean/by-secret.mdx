...
* A window will appear displaying the available cloud providers (Amazon, Azure, DigitalOcean, Linode, Google). Select the <b> Digital Ocean </b> to import your cluster.
