...
* [Choose File ](/cluster_managment/cluster_import/azure/by-config#choose-file): Upload a Kubeconfig file directly.
* [Manual Kubeconfig](/cluster_managment/cluster_import/azure/by-config#manual-kubeconfig): Manually enter the Kubeconfig details.
<br />
...
<br />
![Import-Cluster](/import_cluster/kubeconfig/kubeconfig3.png)<br />
##### Manual KubeConfig:
